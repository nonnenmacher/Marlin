...
// from Hogan file version : "1.0.3 dev" extracted from geeetech Wiki site
#define STRING_CONFIG_H_AUTHOR "(Nonnenmacher, Geeetech Delta G2S)" // Who made the changes.
...
#define DELTA
  ...
  // warning Geeetech file add a -1 to the final carriage_offset with formula
...
#define Z_PROBE_ALLEN_KEY
  ...
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_Y DELTA_PRINTABLE_RADIUS - 40.0
